...
<?php
    if(isset($_POST['btnRegister']))
    {
        ...
        if($us=="" || $pass1=="" || $pass2=="" || $fullname=="" || $email=="" || $address=="" || !isset($sex)){
            $err .= "<li>Enter field with (*), please</li>";
        }
        if(strlen($pass1)<5){
            $err .= "<li>Password must be longer than 5</li>";
        }
        if($pass1!=$pass2){
            $err .= "<li>Password does not match</li>";
        }
        if($_POST['slYear']=="0"){
            $err .= "<li>Enter year of birth please</li>";
        }
        if($err !=""){
            echo $err;
        }
...
<div class="container">
        <h2>Member Registration</h2>
			 	<form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form" onsubmit="return check()">
